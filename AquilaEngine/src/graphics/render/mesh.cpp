...
void Mesh::CreateBuffers()
{
	...
	AQUILA_CHECK(!instance.vertices.empty(), "Mesh: vertex list is empty");
	AQUILA_CHECK(!instance.indices.empty(), "Mesh: index list is empty");
...
{
	AQUILA_CHECK(rtVertexBuffer != nullptr, "Mesh: RT vertex buffer is missing");
	AQUILA_CHECK(rtIndexBuffer != nullptr, "Mesh: RT index buffer is missing");
