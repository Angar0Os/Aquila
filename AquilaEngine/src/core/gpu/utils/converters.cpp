...
vk::ImageLayout core::gpu::utils::ToVulkan(core::gpu::utils::EImageLayout _layout)
{
	switch (_layout)
	{
	case core::gpu::utils::EImageLayout::Undefined:
		return vk::ImageLayout::eUndefined;

	case core::gpu::utils::EImageLayout::General:
		return vk::ImageLayout::eGeneral;

	case core::gpu::utils::EImageLayout::ColorAttachment:
		return vk::ImageLayout::eColorAttachmentOptimal;

	case core::gpu::utils::EImageLayout::DepthStencilAttachment:
		return vk::ImageLayout::eDepthStencilAttachmentOptimal;

	case core::gpu::utils::EImageLayout::ShaderReadOnly:
		return vk::ImageLayout::eShaderReadOnlyOptimal;

	case core::gpu::utils::EImageLayout::TransferSrc:
		return vk::ImageLayout::eTransferSrcOptimal;

	case core::gpu::utils::EImageLayout::TransferDst:
		return vk::ImageLayout::eTransferDstOptimal;

	case core::gpu::utils::EImageLayout::Present:
		return vk::ImageLayout::ePresentSrcKHR;
	}

	AQUILA_ERROR("Unsupported image layout");
}
...
vk::DescriptorType core::gpu::utils::ToVulkan(core::gpu::utils::EDescriptorType type)
{
	...
	default:
		AQUILA_ERROR("Unknown descriptor type");
	}
}
