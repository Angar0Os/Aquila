...
void Pipeline::SetDebugName(const Device& _device, std::string_view _name)
{
	core::debug::SetObjectName(_device, VK_OBJECT_TYPE_PIPELINE,
		reinterpret_cast<uint64_t>(static_cast<VkPipeline>(*m_impl->pipeline)), _name);
}
