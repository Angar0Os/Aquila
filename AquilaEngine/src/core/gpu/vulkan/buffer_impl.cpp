...
void Buffer::SetDebugName(const Device& _device, std::string_view _name)
{
	core::debug::SetObjectName(_device, VK_OBJECT_TYPE_BUFFER,
		reinterpret_cast<uint64_t>(static_cast<VkBuffer>(*m_impl->buffer)), _name);
}
