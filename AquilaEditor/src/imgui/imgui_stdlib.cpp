...
std::string ImGui::InputTextAtEditStart()
{
    ImGuiContext& g = *GImGui;
    auto& inputTextState = g.InputTextState;

    return std::string((const char*)inputTextState.TextToRevertTo.Data, (size_t)inputTextState.TextToRevertTo.Size - 1);
}
